 ...
 * mybatis3.4.0 之后，StatementHandler的prepare方法做了修改，如下：
 * Statement prepare(Connection connection, Integer transactionTimeout) throws SQLException;  
 * 、在args = { Connection.class }中添加第二个参数Integer.class
 */
...
public class MybatisPageInterceptor implements Interceptor{
	...
	public Object intercept(Invocation invocation) throws Throwable {
		  // logger.info("MybatisPageInterceptor被执行" +Thread.currentThread());
           ...
           MetaObject metaStatementHandler =MetaObject.forObject(delegate, DEFAULT_OBJECT_FACTORY, DEFAULT_OBJECT_WRAPPER_FACTORY, DEFAULT_REFLECTOR_FACTORY);  //MetaObject.forObject(delegate, DEFAULT_OBJECT_FACTORY, DEFAULT_OBJECT_WRAPPER_FACTORY);
